...
function () {
  ...
  _createClass(Enlarge, [{
    ...
    value: function setStyle() {
      ...
      var style = window.getComputedStyle(this.enlarge).backgroundSize; // let bgx = parseInt(style.split(" ")[0]);
    ...
    value: function changeImg(ele) {
      ...
      this.showImg.setAttribute("src", img.getAttribute("midelimg")); // 更改放大镜的背景图

      this.enlarge.style.backgroundImage = "url(".concat(img.getAttribute("bigImg"), ")");
    }
  }]);
